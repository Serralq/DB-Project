...
source "/home/serralq/stow/Remote/Downloads/School/DB-Project/.devenv/shell-env.sh"
...
__devenv_reload_apply() {
    ...
    if [ -f "/tmp/devenv-reload-60605.sh" ]; then
        ...
        source "/tmp/devenv-reload-60605.sh"
        rm -f "/tmp/devenv-reload-60605.sh"

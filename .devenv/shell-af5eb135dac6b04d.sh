...
DEVENV_PROFILE='/nix/store/yvaidsyzjdxx1cd34p5mg20rxbwxh480-devenv-profile'
...
depsHostHost=''
export depsHostHost
out='/nix/store/2hz9lf4yp94hnqf7r3vrxprl2yh8bax4-devenv-shell-env'
export out
OLDPWD=''
export OLDPWD
CC='gcc'
...
if [ ! -L "$DEVENV_DOTFILE/profile" ] || [ "$(/nix/store/74sind1d6vf2bfwd7yklg8chsvzqxmmq-coreutils-9.10/bin/readlink $DEVENV_DOTFILE/profile)" != "/nix/store/yvaidsyzjdxx1cd34p5mg20rxbwxh480-devenv-profile" ]
then
  ln -snf /nix/store/yvaidsyzjdxx1cd34p5mg20rxbwxh480-devenv-profile "$DEVENV_DOTFILE/profile"
fi
...
OBJCOPY='objcopy'
export OBJCOPY
NIX_LDFLAGS='-rpath /nix/store/2hz9lf4yp94hnqf7r3vrxprl2yh8bax4-devenv-shell-env/lib  -L/nix/store/6f0dpgy5d8dc1yids8jwpczq0djklb65-mariadb-server-11.4.9/lib -L/nix/store/6f0dpgy5d8dc1yids8jwpczq0djklb65-mariadb-server-11.4.9/lib'
export NIX_LDFLAGS
...
prefix='/nix/store/2hz9lf4yp94hnqf7r3vrxprl2yh8bax4-devenv-shell-env'
HOSTTYPE='x86_64'
outputBin='out'
...
exec /tmp/devenv-envIbPGeF/script 